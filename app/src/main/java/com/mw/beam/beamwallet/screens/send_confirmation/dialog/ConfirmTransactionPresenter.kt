...
class ConfirmTransactionPresenter(view: ConfirmTransactionContract.View?, repository: ConfirmTransactionContract.Repository)
    : BasePresenter<ConfirmTransactionContract.View, ConfirmTransactionContract.Repository>(view, repository), ConfirmTransactionContract.Presenter {
