...
object PreferencesManager {
    ...
    const val KEY_CURRENCY = "KEY_CURRENCY_NEW_NEW"
   // const val KEY_CURRENCY_RECOVER = "KEY_CURRENCY_RECOVER"
    ...
    const val KEY_GENERATE_NEW_ADDRESS_HINT_SHOWN = "KEY_GENERATE_NEW_ADDRESS_HINT_SHOWN"
    const val IGNORE_CONTACTS = "IGNORE_CONTACTS_NEW"

    const val KEY_TRANSACTIONS = "KEY_TRANSACTIONS23"
    ...
    const val KEY_ASSETS = "KEY_ASSETS_8"
