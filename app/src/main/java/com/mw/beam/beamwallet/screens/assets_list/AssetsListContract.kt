...
interface AssetsListContract {
    interface View: MvpView {
        fun init()
        fun showAssetDetails(asset: Asset)
        fun configAssets(asset: List<Asset>)
        fun showActivatePrivacyModeDialog()
        fun configPrivacyStatus()
    }

    interface Presenter: MvpPresenter<View> {
        fun onAssetPressed(asset: Asset)
        fun onChangeFilter(filter:AssetFilter)
